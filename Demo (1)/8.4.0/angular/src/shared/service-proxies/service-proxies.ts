...
export class DepartmentServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DepartmentDtoPagedResultDto> {
    ...
    createOrEdit(body: CreateOrEditDepartmentDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Department/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getDepartmentForEdit(id: number | undefined): Observable<GetDepartmentForEditOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDepartmentForEdit(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetDepartmentForEditOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetDepartmentForEditOutput>;
        }));
    }
...
export class DesignationServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<DesignationDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<DesignationDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<DesignationDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<DesignationDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = DesignationDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditDesignationDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    getDepartmentForEdit(id: number | undefined): Observable<GetDesignationForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Designation/GetDepartmentForEdit?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetDesignationForEditOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetDesignationForEditOutput>;
        }));
    }

    protected processGetDepartmentForEdit(response: HttpResponseBase): Observable<GetDesignationForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetDesignationForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAll(filter: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<EmployeeDtoPagedResultDto> {
    ...
    createOrEdit(body: CreateOrEditEmployeeDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Employee/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getEmployeeForEdit(id: number | undefined): Observable<GetEmplyeeForEditOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetEmplyeeForEditOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetEmplyeeForEditOutput>;
        }));
    }

    protected processGetEmployeeForEdit(response: HttpResponseBase): Observable<GetEmplyeeForEditOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetEmplyeeForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getNamesForDepartment(): Observable<Int32NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetNamesForDepartment";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetNamesForDepartment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetNamesForDepartment(response_ as any);
                } catch (e) {
    ...
    protected processGetNamesForDepartment(response: HttpResponseBase): Observable<Int32NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getNamesForDesignation(): Observable<Int32NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetNamesForDesignation";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetNamesForDesignation(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetNamesForDesignation(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Int32NameValueDto[]>;
                }
            } else
    ...
    protected processGetNamesForDesignation(response: HttpResponseBase): Observable<Int32NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CreateOrEditDepartmentDto implements ICreateOrEditDepartmentDto {
    ...
    clone(): CreateOrEditDepartmentDto {
        const json = this.toJSON();
        let result = new CreateOrEditDepartmentDto();
        result.init(json);
        return result;
...
export class CreateOrEditDesignationDto implements ICreateOrEditDesignationDto {
    ...
    clone(): CreateOrEditDesignationDto {
        const json = this.toJSON();
        let result = new CreateOrEditDesignationDto();
        result.init(json);
        return result;
...
export class DesignationDtoPagedResultDto implements IDesignationDtoPagedResultDto {
    items: DesignationDto[] | undefined;
    totalCount: number;

    constructor(data?: IDesignationDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(DesignationDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): DesignationDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new DesignationDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): DesignationDtoPagedResultDto {
        const json = this.toJSON();
        let result = new DesignationDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IDesignationDtoPagedResultDto {
    items: DesignationDto[] | undefined;
    totalCount: number;
}
...
export class EmployeeDto implements IEmployeeDto {
    ...
    designationId: number;
    departmentId: number;
    depatmentName: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.designationId = _data["designationId"];
            this.departmentId = _data["departmentId"];
            this.depatmentName = _data["depatmentName"];
...
export class GetDepartmentForEditOutput implements IGetDepartmentForEditOutput {
    createOrEditDepartmentDto: CreateOrEditDepartmentDto;
    ...
    init(_data?: any) {
        if (_data) {
            this.createOrEditDepartmentDto = _data["createOrEditDepartmentDto"] ? CreateOrEditDepartmentDto.fromJS(_data["createOrEditDepartmentDto"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["createOrEditDepartmentDto"] = this.createOrEditDepartmentDto ? this.createOrEditDepartmentDto.toJSON() : <any>undefined;
        return data;
    }
...
export class GetDesignationForEditOutput implements IGetDesignationForEditOutput {
    createOrEditDesignationDto: CreateOrEditDesignationDto;
    ...
    init(_data?: any) {
        if (_data) {
            this.createOrEditDesignationDto = _data["createOrEditDesignationDto"] ? CreateOrEditDesignationDto.fromJS(_data["createOrEditDesignationDto"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["createOrEditDesignationDto"] = this.createOrEditDesignationDto ? this.createOrEditDesignationDto.toJSON() : <any>undefined;
        return data;
    }

    clone(): GetDesignationForEditOutput {
        const json = this.toJSON();
        let result = new GetDesignationForEditOutput();
        result.init(json);
        return result;
...
export class GetEmplyeeForEditOutput implements IGetEmplyeeForEditOutput {
    createOrEditEmployeeDto: CreateOrEditEmployeeDto;

    constructor(data?: IGetEmplyeeForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.createOrEditEmployeeDto = _data["createOrEditEmployeeDto"] ? CreateOrEditEmployeeDto.fromJS(_data["createOrEditEmployeeDto"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetEmplyeeForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetEmplyeeForEditOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["createOrEditEmployeeDto"] = this.createOrEditEmployeeDto ? this.createOrEditEmployeeDto.toJSON() : <any>undefined;
        return data;
    }

    clone(): GetEmplyeeForEditOutput {
        const json = this.toJSON();
        let result = new GetEmplyeeForEditOutput();
        result.init(json);
        return result;
...
export interface IGetEmplyeeForEditOutput {
    createOrEditEmployeeDto: CreateOrEditEmployeeDto;
}
